...
class _MacosPopupMenuState<T> extends State<_MacosPopupMenu<T>> {
  ...
  @override
  Widget build(BuildContext context) {
    final MacosPopupRoute<T> route = widget.route;
...
class MacosPopupRoute<T> extends PopupRoute<_MacosPopupRouteResult<T>> {
  MacosPopupRoute({
    required this.items,
...
class MacosPopupRoutePage<T> extends StatelessWidget {
  const MacosPopupRoutePage({
    super.key,
    required this.route,
    required this.constraints,
    this.items,
